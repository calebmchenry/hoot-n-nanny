...
export const UI_COPY = {
  ...
  audioControlsLabel: 'Audio controls',
  audioExpandLabel: 'Open audio controls',
  audioCollapseLabel: 'Close audio controls',
  audioMuteLabel: 'Mute all audio',
  audioUnmuteLabel: 'Unmute all audio',
  audioMuteAction: 'Mute',
  audioUnmuteAction: 'Unmute',
  audioMusicLabel: 'Music volume',
  audioSfxLabel: 'SFX volume',
  audioUnlockHint: 'Audio unlocks after your first interaction.',
  nightStartQuips: [
